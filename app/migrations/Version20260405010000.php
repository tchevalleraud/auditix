...
final class Version20260405010000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE context ADD COLUMN public_enabled BOOLEAN NOT NULL DEFAULT FALSE');
        $this->addSql('ALTER TABLE context ADD COLUMN public_token VARCHAR(64) DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_context_public_token ON context (public_token)');
    }
