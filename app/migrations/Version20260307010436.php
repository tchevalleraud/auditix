 ...
 */
final class Version20260307010436 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE node DROP is_reachable');
        $this->addSql('ALTER TABLE node DROP last_ping_at');
    }
}
