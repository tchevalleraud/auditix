...
final class Version20260404010000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_schedule_context ON schedule (context_id)');
        $this->addSql('CREATE INDEX IDX_schedule_next_run ON schedule (next_run_at)');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_schedule_context FOREIGN KEY (context_id) REFERENCES context (id) ON DELETE CASCADE');
    }
