...
final class Version20260308163000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE device_model ADD COLUMN IF NOT EXISTS send_ctrl_char VARCHAR(1) DEFAULT NULL');
        $this->addSql("UPDATE device_model SET send_ctrl_char = 'Y' WHERE send_ctrl_y = true AND send_ctrl_char IS NULL");
        $this->addSql('ALTER TABLE device_model DROP COLUMN IF EXISTS send_ctrl_y');
    }
