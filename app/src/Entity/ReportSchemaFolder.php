...
/**
 * User-created folder to organise report schemas into a tree.
 * Self-referencing parent/children for nesting; scoped to a Context.
 */
#[ORM\Entity]
#[ORM\Table(name: 'report_schema_folder')]
#[ORM\Index(columns: ['context_id'], name: 'idx_report_schema_folder_context')]
#[ORM\Index(columns: ['parent_id'], name: 'idx_report_schema_folder_parent')]
class ReportSchemaFolder
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
